...
class Application(Frame):
    ...
    def widgets(self):
		...
		self.speed_plus_button = Button(self,text="Speed Up",command=lambda: speed_command(str(877)))
		self.speed_plus_button.grid(column=5,row=6)
		self.speed_plus_button = Button(self, text="Speed Down",command=lambda: speed_command(str(844)))
		self.speed_plus_button.grid(column=6, row=6)
		
		self.speed_plus_button = Button(self,text="Heading Up",command=lambda: heading_command(str(877)))
		self.speed_plus_button.grid(column=5,row=7)
		self.speed_plus_button = Button(self, text="Heading Down",command=lambda: heading_command(str(844)))
		self.speed_plus_button.grid(column=6, row=7)
		self.speed_plus_button = Button(self,text="Depth Up",command=lambda: depth_command(str(998)))
		self.speed_plus_button.grid(column=5,row=8)
		self.speed_plus_button = Button(self, text="Depth Down",command=lambda: depth_command(str(997)))
		self.speed_plus_button.grid(column=6, row=8)
		self.speed_plus_button = Button(self,text="Pitch Up",command=lambda: pitch_command(str(877)))
		self.speed_plus_button.grid(column=5,row=9)
		self.speed_plus_button = Button(self, text="Pitch Down",command=lambda: pitch_command(str(844)))
