...
class Joystick:
    ...
    def sample(self):
        (x1,y1) = self.leftStick()
        (x2,y2) = self.rightStick()
        values = {
            'dpadUp':self.dpadUp(),
            ...
            'Guide':self.Guide(),
            'Start':self.Start(),
            'leftThumbstick':self.leftThumbstick(),
            'rightThumbstick':self.rightThumbstick(),
            'A':self.A(),
            'B':self.B(),
            'X':self.X(),
            'Y':self.Y(),
            ...
            'leftTrigger':round(self.leftTrigger()),
            'rightTrigger':round(self.rightTrigger()),
            'left_x':x1,
            'left_y':y1,
            'right_x':x2,
            'right_y':y2
