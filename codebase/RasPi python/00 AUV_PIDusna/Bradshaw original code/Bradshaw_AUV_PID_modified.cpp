...
// ServoOut m3_servoOut(p24);     //starboard thruster
// ServoOut m4_servoOut(p25);     //port thruster
ServoOut port_thrust(p21);
ServoOut starboard_thrust(p22);
ServoOut fore_thrust(p24);
ServoOut aft_thrust(p25);

float ticker_rate = 0.02;
...
volatile float pitch_Dk =0.00000;
...
volatile float depth_Ik =0.0f;      //.055
