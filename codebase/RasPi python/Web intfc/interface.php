...
<html>
  ...
  <body onload="setTimeout('init(0,25,1);', 100);">
     <div>
         ...
         <input id="leak_button" type="button" class="btn btn-danger">
         &nbsp&nbsp&nbsp
         &nbsp&nbsp&nbsp
         &nbsp&nbsp&nbsp
         ...
         &nbsp&nbsp&nbsp
         Leak:&nbsp&nbsp&nbsp
         <?php echo DisplaySerial(leak_detect); ?>
      </div>
      <div>
         <input type="button" value="Reset Mbed Microcontroller" onclick="stop_python(); send_cmd2('res:000');">
